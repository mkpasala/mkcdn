 ...
 var createlogbookObject = (function() { 
    return { 
      init: function() { debugger;
        var doc = document.querySelector('#logbook').import;
        var text = doc.querySelector('html');
        document.getElementById("logbook_content").appendChild(text.cloneNode(true));
      } 
    } 
  })(createlogbookObject||{})
